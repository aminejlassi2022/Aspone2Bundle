...
class AsponeDeposit
{
    ...
    /**
     * @var ArrayCollection|AsponeDeclaration[]
     * @ORM\OneToMany(targetEntity="II\Bundle\DeclarableAsponeBundle\Entity\AsponeDeclaration", mappedBy="deposit")
     */
    protected $declarations;

    /**
     * @var ArrayCollection|AsponeDepositHistorique[]
     *
     * @ORM\OneToMany(targetEntity="InterInvest\Aspone2Bundle\Entity\AsponeDepositHistorique", mappedBy="deposit")
     * @ORM\JoinColumns({
    ...
    {
        $this->interchangeid = intval($interchangeid);
    ...
    /**
     * @return ArrayCollection|AsponeDeclaration[]
     */
